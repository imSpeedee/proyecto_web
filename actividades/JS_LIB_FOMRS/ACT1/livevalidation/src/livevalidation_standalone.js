...
var Validate = {
    ...
    Presence: function(value, paramsObj){
    	...
    	var message = paramsObj.failureMessage || "No pot estar buit!";
    ...
    Numericality: function(value, paramsObj){
        ...
        var notANumberMessage = paramsObj.notANumberMessage || "Ha de ser un número!";
        var notAnIntegerMessage = paramsObj.notAnIntegerMessage || "Ha de ser un enter!";
    	var wrongNumberMessage = paramsObj.wrongNumberMessage || "Ha de ser " + is + "!";
    	var tooLowMessage = paramsObj.tooLowMessage || "No pot ser menor que " + minimum + "!";
    	var tooHighMessage = paramsObj.tooHighMessage || "No pot ser major que " + maximum + "!";
   ...
   *                           (DEFAULT: false)
    ...
    Format: function(value, paramsObj){
      ...
      var paramsObj = paramsObj || {};
      var message = paramsObj.failureMessage || "No és correcte!";
    ...
    Email: function(value, paramsObj){
    	var paramsObj = paramsObj || {};
    	var message = paramsObj.failureMessage || "Ha de ser una adreça de correu electrònic!";
    ...
    Length: function(value, paramsObj){
    	...
    	var tooLongMessage = paramsObj.tooLongMessage || "Ha de contenir com a màxim " + maximum + " caràcters!";
    	switch(true){
    	  	case (is !== null):
    ...
    Inclusion: function(value, paramsObj){
    	var paramsObj = paramsObj || {};
    	var message = paramsObj.failureMessage || "Ha d'estar inclòs a la llista!";
    ...
    Exclusion: function(value, paramsObj){
      var paramsObj = paramsObj || {};
      paramsObj.failureMessage = paramsObj.failureMessage || "No ha d'estar inclòs a la llista!";
    ...
    Confirmation: function(value, paramsObj){
    	...
    	var paramsObj = paramsObj || {};
    	var message = paramsObj.failureMessage || "No coincideixien les contrasenyes!";
    ...
    Acceptance: function(value, paramsObj){
      	var paramsObj = paramsObj || {};
    	var message = paramsObj.failureMessage || "Has d'acceptar les condicions!";
