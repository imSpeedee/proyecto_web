...
var Validate = {
   ...
   *                           (DEFAULT: false)
    ...
    Email: function(value, paramsObj){
    	var paramsObj = paramsObj || {};
    	var message = paramsObj.failureMessage || "Ha de ser una adreça electrònica amb format vàlid!";
    ...
    Confirmation: function(value, paramsObj){
    	...
    	var paramsObj = paramsObj || {};
    	var message = paramsObj.failureMessage || "No coincideix!";
    ...
    Acceptance: function(value, paramsObj){
      	var paramsObj = paramsObj || {};
    	var message = paramsObj.failureMessage || "Has de marcar la casella!";
